...
class Header extends Component {
    ...
    render() {
        return ( <
            ...
            <
            Form.Label style = {
                { fontSize: 18 } } > Password < /Form.Label> <
            ...
            <
            Form.Label style = {
                { fontSize: 18 } } > First Name < /Form.Label> <
            ...
            <
            Form.Label style = {
                { fontSize: 18 } } > Last Name < /Form.Label> <
            Form.Control placeholder = ""
            ...
            Phone Number <
            /Form.Label> <
            Form.Control value = { this.state.newContact }
            name = "newContact"
            onChange = { this.onChange }
            /> <
            /Form.Group> <
